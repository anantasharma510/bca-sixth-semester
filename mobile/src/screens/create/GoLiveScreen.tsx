 ...
 * This screen is for creating and managing live streams using Agora.io
 * To re-enable, uncomment this file and restore the navigation route in PostCreationNavigator.tsx
 */
...
type GoLiveScreenProps = StackScreenProps<PostCreationStackParamList, 'GoLive'>;

export const GoLiveScreen: React.FC<GoLiveScreenProps> = ({ navigation }) => {
