...
export function createAndEmitNotification(data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield notification.populate('sender', 'username firstName lastName profileImageUrl');
            if (data.post) {
                yield notification.populate('post', 'content');
            }
            if (data.comment) {
                yield notification.populate('comment', 'content');
            }
