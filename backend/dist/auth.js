...
const ENV_TRUSTED_ORIGINS = (process.env.BETTER_AUTH_TRUSTED_ORIGINS || process.env.ALLOWED_ORIGINS || "")
    ...
    .filter(Boolean);
export const BETTER_AUTH_TRUSTED_ORIGINS = Array.from(new Set([...DEFAULT_TRUSTED_ORIGINS, ...ENV_TRUSTED_ORIGINS]));
...
let authDb = null;
export const initializeAuth = () => __awaiter(void 0, void 0, void 0, function* () {
    if (authInstance) {
        return authInstance;
    }
...
export const closeAuthConnection = () => __awaiter(void 0, void 0, void 0, function* () {
    if (mongoClient) {
