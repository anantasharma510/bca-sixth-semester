...
io.use((socket, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { getAuth } = yield import('./auth');
        const auth = getAuth();
        ...
        const { User } = yield import('./models/user.model.js');
        ...
        socket.data.user = {
            id: (dbUser === null || dbUser === void 0 ? void 0 : dbUser._id) || session.user.id
        };
        next();
    }
    catch (err) {
...
io.on('connection', (socket) => {
    ...
    const updateUserOnlineStatus = (isOnline) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { User } = yield import('./models/user.model.js');
            ...
            const { Conversation } = yield import('./models/conversation.model.js');
    ...
    socket.on('joinConversations', (conversationIds) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const validConversationIds = conversations.map((c) => c._id.toString());
            ...
            validConversationIds.forEach((id) => socket.join(id));
    ...
    socket.on('sendMessage', (data) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const { Message } = yield import('./models/message.model.js');
            const { Conversation } = yield import('./models/conversation.model.js');
            const { User } = yield import('./models/user.model.js');
            ...
            const blockChecks = yield Promise.all(otherParticipants.map((participantId) => __awaiter(void 0, void 0, void 0, function* () {
                const [userBlockedOther, otherBlockedUser] = yield Promise.all([
            ...
            if (content) {
                try {
                    ...
                    const DOMPurifyModule = yield import('isomorphic-dompurify');
            ...
            const messageWithSender = Object.assign(Object.assign({}, message.toObject()), { senderId_details: sender ? {
    ...
    socket.on('messageRead', (_a) => __awaiter(void 0, [_a], void 0, function* ({ conversationId, messageId }) {
    ...
    socket.on('typing', (_a) => __awaiter(void 0, [_a], void 0, function* ({ conversationId }) {
    ...
    socket.on('stopTyping', (_a) => __awaiter(void 0, [_a], void 0, function* ({ conversationId }) {
    ...
    // Handle block events
    socket.on('userBlocked', (_a) => __awaiter(void 0, [_a], void 0, function* ({ blockedUserId }) {
    ...
    socket.on('userUnblocked', (_a) => __awaiter(void 0, [_a], void 0, function* ({ unblockedUserId }) {
    ...
    socket.on('joinStream', (streamId) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Update viewer count
        try {
            const { LiveStream } = yield import('./models/liveStream.model.js');
            yield LiveStream.findByIdAndUpdate(streamId, {
                $inc: { viewerCount: 1 }
            });
            // Broadcast updated viewer count
            const stream = yield LiveStream.findById(streamId);
            if (stream) {
    ...
    socket.on('leaveStream', (streamId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    socket.on('streamChatMessage', (data) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const { User } = yield import('./models/user.model.js');
            const { StreamChatMessage } = yield import('./models/streamChat.model.js');
            const user = yield User.findById(userId);
            const chatMessage = {
                id: Date.now().toString() + '_' + Math.random().toString(36).substr(2, 9),
                streamId,
                userId,
                username: (user === null || user === void 0 ? void 0 : user.username) || (user === null || user === void 0 ? void 0 : user.firstName) || 'Anonymous',
                message: message.trim(),
                timestamp: new Date(),
                avatar: user === null || user === void 0 ? void 0 : user.profileImageUrl
            };
            // Save message to database for persistence
            yield StreamChatMessage.create({
                streamId,
                userId,
    ...
    socket.on('streamReaction', (data) => __awaiter(void 0, void 0, void 0, function* () {
...
const startServer = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const BETTER_AUTH_PROXY_ORIGIN = process.env.BETTER_AUTH_PROXY_ORIGIN ||
            process.env.FRONTEND_URL ||
            'http://localhost:3000';
        app.use((req, _res, next) => {
            var _a;
            if (req.path.startsWith('/api/auth')) {
                const originHeader = (_a = req.headers.origin) === null || _a === void 0 ? void 0 : _a.trim();
                if (!originHeader ||
